                            ...
                            <Col md={6}>
                                <Collapse bordered={false} >
                                    ...
                                    <Panel header="Какая организация занималась созданием сайта?" key="2">
                                        Сайт является дипломным проектом, сойт создавался ожним человеком. Email (uomostella@gmail.com)
                                    </Panel>
                                    <Panel header="Как можно поддержать проект?" key="3">
                                        Свяжитесь с создателем Email (uomostella@gmail.com). И предложите вариант поддержки.
                                    </Panel>
                                </Collapse>
                            </Col>
                            <Col md={6}>
